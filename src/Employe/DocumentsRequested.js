    ...
    fetch((url),{
        ...
        .then( (res)=>{
          ...
          if( res.status == 404 || res.status == '404'){
            this.setState({
              errorFlag:true,
              errorText:<div className="callout callout-warning">
          ...
          if( res.status == 200 || res.status == '200'){
            this.setState({
              errorFlag:true,
              errorText:<div className="callout callout-success">
      ...
      <div className="row">
        <div className="col-xs-12">
          <div className="box">
            ...
            {this.state.loader ? 
            <div>
              <center><h4><i className="fa fa-spinner fa-pulse fa-3x fa-fw"></i>
    ...
    <div className="modal-content">
      ...
      <div className="row">
                        <div className="col-md-6">
                          ...
                          <div className="form-group">
                          <input type="password" className="form-control" id="userpin" placeholder="Please enter your ipin" 
                        ...
                        <div className="col-md-6">
                          ...
                          <div className="form-group">
                          <input type="text" className="form-control" id="docs-note" placeholder="Please Enter Note For Docs" 
