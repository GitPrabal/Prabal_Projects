...
class Expenses extends Component {
    ...
    sendExpenses = () =>{
        ...
        fetch('http://localhost/ReactApi/InsertExpenses.php?price='+price+'&date='+date+'&desc='+desc+'&user_id='+user_id)
        .then( (res) => res.json() )
        .then( (res) =>{
                                        ...
                                        <form role="form">
                                            <div className="box-body">
                                                ...
                                                :null 
                                                    ...
                                                    <input type="date" className="form-control" id="date" placeholder="Enter email" 
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    onChange={this.changeDesc} id="description"
                                                    ></textarea>
                                                </div>
                                            </div>
                                            <div class="box-footer">
                                                <button type="button" onClick={this.sendExpenses} className="btn btn-primary">Submit</button>
                                            </div>
                                        </form>
                                    </div>
                                </section>
